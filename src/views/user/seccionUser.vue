<template>
    <q-page class="main-user-bg">
        ...
        <q-header elevated :class="$q.dark.isActive ? 'bg-dark' : 'bg-primary'" class="text-white">
            <q-toolbar class="q-py-sm">
                ...
                <div class="gt-xs q-mr-md">
                    <q-input dense outlined v-model="search" placeholder="Buscar sabiduría..." color="secondary" :dark="$q.dark.isActive">
                ...
                <q-btn flat round :icon="$q.dark.isActive ? 'light_mode' : 'dark_mode'" @click="$q.dark.toggle()" class="q-mr-sm" />
            ...
            <q-page padding class="container-max-width">
                ...
                <div class="q-mb-xl">
                    <div v-if="!lecturaPrincipal" class="row justify-center">
                        <q-card class="main-reading-promo glass-morphism text-center q-pa-xl">
                            ...
                            <q-btn 
                                label="Descubrir mi Esencia" 
                                color="secondary" 
                                size="lg" 
                                rounded 
                                unelevated
                                :loading="loadingPrincipal"
                                @click="generarLecturaPrincipal"
                                class="q-px-xl"
                            />
                        </q-card>
                    </div>
                        ...
                        <div class="row no-wrap">
                            ...
                            <div class="col-12 col-md-8 q-pa-xl">
                                ...
                                <div class="row q-col-gutter-md q-mb-lg">
                                    <div class="col-12">
                                        <div class="text-subtitle2 text-weight-bold text-grey-5 q-mb-xs">Talentos Ocultos</div>
                                        <div class="row q-gutter-xs">
                                            <q-chip v-for="talento in lecturaPrincipal.talentos" :key="talento" 
                                                    outline color="primary" icon="bolt" dense>
                                                {{ talento }}
                                            </q-chip>
                                        </div>
                                    </div>
                ...
                <div class="row justify-center q-mb-xl">
                    <q-btn 
                        ...
                        :disabled="!lecturaPrincipal"
                        class="oracle-btn q-px-xl q-py-lg"
                        unelevated
                        rounded
                    >
                                ...
                                <div class="row q-col-gutter-lg">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card flat class="bg-primary-transparent q-pa-md text-center border-accent">
                                            ...
                                            <div class="text-h4 text-weight-bolder q-my-sm">{{ lecturaHoy.energiaDelDia }}</div>
        ...
        <q-footer :class="$q.dark.isActive ? 'bg-dark' : 'bg-grey-2'" class="text-center q-pa-lg text-grey-7 border-top">
